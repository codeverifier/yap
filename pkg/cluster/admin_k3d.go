...
func (a *k3dAdmin) Create(ctx context.Context, desired *api.Cluster) error {
	...
	k3dConfig, err := a.clusterConfig(desired)
	if err != nil {
...
func (a *k3dAdmin) clusterConfig(desired *api.Cluster) (*k3dv1alpha4.SimpleConfig, error) {
