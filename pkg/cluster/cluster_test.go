...
// Make sure that an empty config doesn't confuse yap.
...
// Make sure an empty context doesn't confuse yap.
...
func newFixture(t *testing.T) *fixture {
	...
	dockerClient := &fakeDockerClient{host: "unix:///home/User/.docker/desktop/docker.sock", ncpu: 1}
...
func (a *fakeAdmin) Create(ctx context.Context, config *api.Cluster) error {
